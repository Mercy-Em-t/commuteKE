        ...
        <div className="min-h-screen bg-slate-50 p-8 font-sans">
            <div className="max-w-6xl mx-auto relative">
                <header className="mb-8 flex justify-between items-end border-b pb-6 border-slate-200">
                    ...
                    <a href="/admin/library" className="bg-white border border-slate-200 hover:border-sky-500 hover:text-sky-600 text-slate-600 px-4 py-2 rounded-lg font-bold shadow-sm transition-all flex items-center gap-2">
